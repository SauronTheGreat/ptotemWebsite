# RailsAdmin config file. Generated on January 08, 2014 23:37
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ptotem Website', 'Admin']
  ...
  # config.excluded_models = ['Company', 'Employee', 'Product']

  # Include specific models (exclude the others):
  # config.included_models = ['Company', 'Employee', 'Product']
