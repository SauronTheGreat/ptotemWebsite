...
var img_array = gon.employee_images;
var name_array = gon.employee_names;
var text_array = gon.employee_roles;
...
function flipside(newState) {
    if (state == 'home') {
        ...
        $('#parallax_view').animate({
//            left: "-=" + window.innerWidth * 0.55 + "px"
            left: ($("#parallax_view").position().left - window.innerWidth * 0.55)+"px"
        });

        $('#sky').animate({
//            left: "-=" + window.innerWidth * 0.05 + "px"
            left: ($("#sky").position().left - window.innerWidth * 0.05)+"px"
        });
        $('#home').fadeIn();
    } else {
        if (newState == 'aboutUs') {
